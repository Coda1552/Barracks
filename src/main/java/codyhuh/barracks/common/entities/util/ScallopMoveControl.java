...
public class ScallopMoveControl extends MoveControl {
    ...
    public ScallopMoveControl(Mob pMob, int pMaxTurnX, int pMaxTurnY, float pInWaterSpeedModifier, float pOutsideWaterSpeedModifier, boolean pApplyGravity) {
        super(pMob);
    ...
    public void tick() {
        if (this.applyGravity && this.mob.isInWater()) {
            //this.mob.setDeltaMovement(this.mob.getDeltaMovement().add(0.0D, -0.0001D, 0.0D));
        }
