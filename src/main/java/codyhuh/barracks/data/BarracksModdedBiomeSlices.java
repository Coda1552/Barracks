package codyhuh.barracks.data;

import codyhuh.barracks.Barracks;
import codyhuh.barracks.registry.ModBiomes;
...
public class BarracksModdedBiomeSlices {

	public static final ResourceKey<ModdedBiomeSlice> PIONEER = ResourceKey.create(BlueprintDataPackRegistries.MODDED_BIOME_SLICES, new ResourceLocation(Barracks.MOD_ID, "barracks"));
	...
	private static class PioneerBiomeBuilder {
		...
		private final ResourceKey<Biome>[][] OCEANS = new ResourceKey[][]{
				...
				{VANILLA, VANILLA, VANILLA, ModBiomes.SEA_STACKS, ModBiomes.SEA_STACKS}
		};
		...
		private ResourceKey<Biome> pickPeakBiome(int p_187241_, int p_187242_, Climate.Parameter p_187243_) {
			if (p_187241_ <= 2) {
				...
				return this.pickBadlandsBiome(p_187242_, p_187243_);
			}
		}
